...
class OptimizationRequest(BaseModel):
    ...
    # --- NUEVOS CAMPOS PARA CÁLCULO DE TIEMPO ---
...
app = FastAPI(
    title="API de Optimización de Corte v12 - Estimación de Tiempo",
    description="API con torneo de algoritmos y cálculo de tiempo de corte.",
    version="12.0.0"
)
...
def optimize_layout(request: OptimizationRequest):
    ...
    # --- Torneo de algoritmos (sin cambios) ---
    ...
    # --- NUEVO CÁLCULO DE TIEMPO DE CORTE ---
